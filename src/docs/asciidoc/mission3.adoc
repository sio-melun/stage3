...
IMPORTANT: En fait, vous êtes libre d'aller aller au delà même d'un refactoring; N'hésitez pas à revoir aussi bien le modèle de données que les choix ergonomiques UX/UI de Salomé et Angéllique.
